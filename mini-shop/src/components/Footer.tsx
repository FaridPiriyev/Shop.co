  ...
  return (
    <footer className="relative bg-[#F0F0F0] dark:bg-black pt-40 pb-10 mt-30 sm:mt-20">
      <div className="max-w-[1240px] mx-auto px-4 ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-y-10 md:gap-x-8 mb-12">
            ...
            <ul className="flex flex-col gap-4 text-black/60 text-sm md:text-base dark:text-white">
              {[
                ...
                <li key={item}>
                  <a
                    href="#"
                    className="hover:text-black transition-colors dark:hover:text-gray-400"
                  >
                    {item}
                  </a>
                </li>
        ...
        <div className="pt-6 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3">
            {paymentMethods.map((method) => (
              <div
                key={method.id}
                className="w-[46px] h-[30px] bg-white border border-[#D6DCE5] rounded-[5.2px] flex items-center justify-center shadow-sm hover:border-black transition-colors cursor-pointer"
              >
                {method.svg}
              </div>
            ))}
